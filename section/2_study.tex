...
\begin{figure*}
\centering
\subfloat[MySQL\#27287]{\includegraphics[width=0.22\linewidth]{figure/gcc27733-time-cost-line}\label{fig:mysql27287-time}} 
\subfloat[Mozilla\#477564]{\includegraphics[width=0.22\linewidth]{figure/gcc27733-time-cost-line}\label{fig:mozilla477564-time}}
\subfloat[Apache\#34464]{\includegraphics[width=0.22\linewidth]{figure/gcc27733-time-cost-line}\label{fig:apache34464-time}} 
\subfloat[GCC\#27733]{\includegraphics[width=0.22\linewidth]{figure/gcc27733-time-cost-line}\label{fig:gcc27733-time}} \\ 
\vspace{-0.1in}
...
To fix the majority (11/18) of performance problems in this category,
...
To fix other complexity problems (5/18) in this category,
