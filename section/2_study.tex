...
\begin{figure*}
\centering
\subfloat[MySQL\#27287]{\includegraphics[width=0.22\linewidth]{figure/mysql27287-runtime-original-fixed-line}\label{fig:mysql27287-time}} 
\subfloat[Mozilla\#477564]{\includegraphics[width=0.22\linewidth]{figure/mozilla47564-runtime-original-fixed-line}\label{fig:mozilla477564-time}}
\subfloat[Apache\#34464]{\includegraphics[width=0.22\linewidth]{figure/apache34464-runtime-original-fixed-line}\label{fig:apache34464-time}} 
\subfloat[GCC\#27733]{\includegraphics[width=0.22\linewidth]{figure/gcc27733-runtime-original-fixed-line}\label{fig:gcc27733-time}} \\ 
\vspace{-0.1in}
