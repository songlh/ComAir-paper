...
\begin{figure}
\centering
\subfloat[Inner loop]{\includegraphics[width=0.42\linewidth]{figure/mysql27287-complexity-n}\label{fig:mysql27287-in}}
\subfloat[Outer loop]{\includegraphics[width=0.42\linewidth]{figure/mysql27287-complexity-n-square}\label{fig:mysql27287-out}} \\ 
\vspace{-0.1in}
\caption{Cost function of MySQL\#27287 using RMS as input size. XXXXXX} 
\label{fig:mysql27287-2} 
\end{figure} 

RMS is a generic metric for input \textit{size}, 
