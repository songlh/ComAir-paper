...
a loop or a recursive function in a program run to 
record input sizes and cost for sampled instances,
and infer input sizes and cost for the sum of all instances.}
