...
\newcommand{\No}[0]{-}
 \begin{table*}[h!]
  ...
  \begin{tabular}{lccc|ccccccc|cc}
    ...
    \midrule
    Mozilla\#347306 &$88$ &C &$O(N^{2})$&1$_{{5}}$    &$y=9.54*10^{-2}x^2$ & \Yes{{0.99}}  &\Yes{{1.00}}&\Yes{{0.99}}&2.34\% & &1$_{465}$ & 79X \\
    Mozilla\#416628   &$105$    &C   &$O(N^{2})$&1$_{{5}}$&$y=7.20*10^{-3}x^2$& \Yes{{0.99}} &\Yes{{0.99}}&\Yes{{0.99}}&3.77\% & &1$_{394}$  & 1252X \\
    Mozilla\#490742   &$0.157^*$&JS  &$O(N)$    &1$_{{4}}$&$y=5.00x$ & \Yes{{0.99}} &\Yes{{1.00}}&\Yes{{1.00}}&0.22\% & &1$_{8}$    & 54.46\%\\  
    Mozilla\#35294    &$0.195^*$&C++ &$O(N^{2})$&1$_{{5}}$&$y=1.06*10^{-2}x^2$&\Yes{{0.99}} &\Yes{{1.00}}&\Yes{{0.99}}&0.12\% & &1$_{{12}}$  &98X  \\ 
    Mozilla\#477564   &$0.116^*$&JS  &$O(N^{2})$&1$_{{5}}$&$y=6.44*10^{-2}x^2$&\Yes{{0.99}} &\Yes{{0.99}}&\Yes{{0.99}}&2.96\% & &1$_{{5}}$   &129X\\
    \midrule
    MySQL\#27287      &$995$ &C++&$O(N^{2})$&\\
    MySQL\#15811      &$1127$&C++&$O(N^{2})$   &1$_{{5}}$&$y=1.34*10x^2$& \Yes{{0.99}} &\Yes{{0.99}}&\Yes{{0.99}}&4.44\% & &1$_{{223}}$  &57.77\% \\
    \midrule
    Apache\#37184     &$0.092^*$&Java&$O(N)$     &1$_{{3}}$&$y=7.00x$    & \Yes{{1.00}} &\Yes{{1.00}}&\Yes{{1.00}}&3.30\% & &1$_{{7}}$   &$2.85\%$\\
    Apache\#29743     &$0.257^*$&Java&$O(N^{2})$ &1$_{{5}}$&$y=1.56*10^{-4}x^2$&\Yes{{0.99}}  &\Yes{{1.00}}&\Yes{{0.99}}&$1.56\%$& &1$_{{110}}$ &54.11\%\\
    Apache\#34464     &$0.16^* $&Java&$O(N^{2})$ &1$_{{4}}$&$y=5.64*10^{-2}x^2$&\Yes{{0.99}}  &\Yes{{0.99}}&\Yes{{0.99}}&$0.18\%$& &1$_{{9}}$   &38X\\
    Apache\#47223     &$0.162^*$&Java&$O(N^{2})$ &1$_{{4}}$&$y=1.56*10^{-4}x^2$&\Yes{{0.99}}  &\Yes{{0.99}}&\Yes{{0.99}}&$4.14\%$& &1$_{{12}}$  &81X\\
    \midrule
    GCC\#46401&$5521$&C&$O(N^{2})$&1$_{{5}}$&$y=3.12*10^{-3}x^2$  & \Yes{{0.99}} &\Yes{{0.98}}&\Yes{{0.99}}&0.37\%& &1$_{{4249}}$ &32X\\
    GCC\#1687&$2099$&C&$O(2^{N})$&1$_{{5}}$&$y=2.13*10^{2}e^{0.005x}$& \Yes{{0.98}} &\Yes{{0.94}}&\Yes{{0.93}}&$4.57\%$& &1$_{{1481}}$&96X\\
    GCC\#27733&$3217$&C&$O(2^{N})$&1$_{{5}}$&$y=2.33e^{0.003x}$    & \Yes{{0.97}} &\Yes{{0.95}}&\Yes{{0.98}}&$4.34\%$& &1$_{{3537}}$&48X\\
    GCC\#8805&$2538$&C&$O(N^{2})$&1$_{{5}}$&$y=2.08*10^{-5}x^2$    & \Yes{{0.99}} &\Yes{{0.99}}&\Yes{{0.99}}&3.28\% & &1$_{{1373}}$ & 48X \\
    GCC\#21430&$3844$&C&$O(N^{2})$&1$_{{5}}$&$y=1.02*10^{-3}x^2$   & \Yes{{0.99}} &\Yes{{0.99}}&\Yes{{0.99}}&4.63\% & &1$_{{3370}}$ & 23X\\
