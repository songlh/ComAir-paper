\begin{table}[h!]
  ...
  \begin{tabular}{lccccccccccc}
    ...
    \cmidrule(lr){6-9}
    \cmidrule(lr){10-12}
                                    &  KLOC     &  P.L.      &  Complexity &  Buggy C.C.     & main-C    & Re-C    & Overhead  & \# of S.L.         &   Re-C        &  Overhead & \# of S.L.  \\
    \midrule 
    ...
    \midrule
    Apache\#37184     &  $0.092^*$  & Java  & $O(N)$     & Loop  & \ding{51}$_{0.92}$ &  /        & $<$0.01\% & 0  & /  & $<$0.01\% & 0     \\ 
    ...
    GCC\#1687         &  $2099$  & C  & $O(2^{N})$ & R.F. & \ding{51}$_{0.93}$ & \ding{51}$_{0.93}$  & 78{\bf X}  & 14  &\ding{51}$_{0.87}$ & 16{\bf X} & 0  \\
    GCC\#27733        &  $3217$  & C  & $O(2^{N})$ & R.F. & \ding{51}$_{0.91}$ & \ding{51}$_{0.91}$  & 67{\bf X} & 27 & \ding{51}$_{0.86}$  & 7{\bf X} & 0  \\
  ...
  \footnotesize{(This table shows benchmark information and evaluation results for the in-house version of \Tool. In the benchmark-information columns,
   ...
   \ding{51}$_{y}$: calculated similarity using Equation~\ref{eq:sim} is $y$, and y is larger than $0.85$. 
    In the DSS columns, 
