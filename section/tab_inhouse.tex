\begin{table}[h!]
  ...
  \begin{tabular}{lccccccccccc}
    ...
    Mozilla\#490742   &  $0.157^*$  & JS & $O(N)$ & A-L &  \ding{51}$_{0.99}$ & - &  1 &  0   & - & -  &  0              \\
    ...
    \midrule
    Apache\#37184     &  $0.092^*$ & Java  & $O(N)$ & Loop  & \ding{51}$_{0.92}$ & - & 0 & 0  & -  & - & 0     \\ 
    Apache\#29743     &  $0.257^*$  & Java  & $O(N^{2})$ & Loop & \ding{51}$_{0.94}$ &  \ding{51}$_{0.94}$ & 32 & 7  & - & - & 0 \\
    ...
    Collections\#409      & $0.781^*$  & Java & $O(N^{2})$ & A-L & \ding{51}$_{0.99}$ & \ding{51}$_{0.98}$ & 53 & 2 &\ding{51}$_{0.97}$ & 23 & 2     \\
    ...
    Collections\#429-0    & $0.668^*$  & Java & $O(N^{2})$ & Loop & - & - & 35 & 2 & - & - & 0       \\
    Collections\#429-1    & $0.536^*$  & Java & $O(N^{2})$ & Loop & \ding{51}$_{0.86}$ & \ding{51}$_{0.86}$ & 40 & 2 & - & - & 0     \\
    Collections\#429-2    & $0.416^*$ & Java  & $O(N^{2})$ & Loop & - & -  & 21 & 2  & - & - & 0 \\
