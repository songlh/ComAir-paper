\begin{table}[h!]
  ...
  \begin{tabular}{lccccccccccc}
    ...
    Mozilla\#490742   &  $0.157^*$  & JS & $O(N)$ & A-L &  \ding{51}$_{0.99}$ & \ding{51}$_{0.99}$ &  1{\bf X} &  0   & - & $<$0.01\%  &  0              \\
    ...
    \midrule
    Apache\#37184     &  $0.092^*$ & Java  & $O(N)$ & Loop  & \ding{51}$_{0.92}$ & \ding{51}$_{0.92}$ & $<$0.01\% & 0  & -  & $<$0.01\% & 0     \\ 
