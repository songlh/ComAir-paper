...
We first categorize complexity problems based on their complexity types,
and then we study complexity problems in each type from the following three aspects:
