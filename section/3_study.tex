...
in a public user-perceived performance bug benchmark suite. 
...
\item We build a taxonomy for complexity bugs from two sources. 
...
%{\color{red} Todo: now we have two sources}
...
Complexity problems are one of the major reasons to cause slow execution.
...
The numbers of complexity bugs and non-complexity bugs are shown in Figure~\ref{tab:compare}.


\input{section/tab_compare}


We compare complexity problems and non-complexity problems from the following aspects:
why they are introduced, how they are reported, and how they are diagnosed. 


\noindent{\color{red} Todo: How they are introduced?} Whether or not complexity problems 
are more likely to be introduced due to developers’ misunderstanding of workload. 

\noindent{\color{red} Todo: How they are introduced?} Whether or not complexity problems 
are more likely to be reported with descriptions about how to change input size. 

\noindent{\color{red} Todo: How they are diagnosed?} Whether or not 
complexity problems are more likely to be diagnosed using profilers.  
