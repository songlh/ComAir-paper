...
%We also use the ranking number
...
\commentty{I added a sentence describing how we found the ground truth, please
check.}
...
\commentlh{
the production-run version of \Tool with and without optimizations in Section~\ref{sec:opt}.
}
...
%to understand the effect of all our designed optimizations. }
