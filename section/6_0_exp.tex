...
we first use a Pin tool to record executed iteration 
...
\commentty{how did you know which five to instrument
among all code constructs?}
...
optimizations discussed in Section~\ref{sec:opt}.
