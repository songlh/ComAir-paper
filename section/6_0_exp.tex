...
\commentlh{
the production-run version of \Tool with and without optimizations 
...
We also conduct a similar experiment to understand whether the production-run version is 
...
We run each version \textbf{ten} times and compute the 
overhead based by the average execution time. 
\commentlh{
We also measure the overhead while disabling all optimizations 
to understand the benefits of all our designed optimizations. }
