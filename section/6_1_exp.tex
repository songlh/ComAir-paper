...
\commentty{Are we evaluating only sampling and approximation, or all optimization methods
described  in Section 4.1? We should make this part clear.}
\commentlh{addressed.}
...
The production-run version can generate results as accurate as the in-house version,
but with a significantly lower overhead. 
\commentty{What do the above results imply?}
\commentlh{addressed.}
