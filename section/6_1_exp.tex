...
for \textbf{all} benchmarks under both production-run and in-house settings. 
...
\commentty{The optimization does not affect accuracy, but does it reduce
the overhead and to what extent? I think reviewers would ask how much cost
can be saved by the optimization.}
...
\commentty{This is related to my previous comment, would the optimization
help to reduce the overhead?}
